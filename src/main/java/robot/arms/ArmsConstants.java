// Please note that this file is manually improted from the Arms branch not the current arms branch.
// The contribution for this file goes to the original author: xenonerias
...
public class ArmsConstants extends SubsystemBase {
  ...
  public static final double POSITION_FACTOR =
      Units.Radian.of(THROUGHBORE_GEARING * 2 * Math.PI)
          .in(Units.Radian); // what is this? (Made some changes used for the encoder. See
  // RealArms.java)
  public static final double VELOCITY_FACTOR =
      Units.RadiansPerSecond.of((THROUGHBORE_GEARING * 2 * Math.PI) / 60)
